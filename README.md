...
|:--:|---------------|------|-------|-----|--------|
| F01 | Shore level elevation with uniform slightly higher non-shore tiles |  |  |  |  |
...
| F09 | [Soil absorption 1]Singular soil profile, only affected by aquifers and lakes |  |  |  |  |
...
| F17 | [Biomes 1] Singular biome profile (colour palette), affected based on the elevation and moisture levels |  |  |  |  |
| F18 | [Biomes 2] Multiple biome profiles that can be selected at the command line |  |  |  |  |
| F19 | [Shapes 2] Different shape profiles can be selected on the command line |  |  |  |  |
