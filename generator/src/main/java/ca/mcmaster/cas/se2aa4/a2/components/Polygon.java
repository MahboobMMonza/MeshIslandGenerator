...
/**
 * Polygon class which serves as a high-level recorder the data generated by the
 * Generator and any properties from the Mesh when finalized before conversion.
 */
